    ...
    with st.spinner("EcoSnap is typing..."):
        ...
        messages = [
            {"role": "system", "content": '''**Prohibited Content**: Do not respond to questions or prompts that are unrelated to ecological or environmental topics. Politely redirect the conversation if needed.
             ...
             Your primary mission is to assist users in understanding ecological, environmental, and waste management topics. You are to provide accurate information on waste disposal methods, recycling tips, and sustainable practices. You should also suggest eco-friendly alternatives when relevant. User will be from India.
             Guidelines:
